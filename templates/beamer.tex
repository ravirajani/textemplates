...
{%
  \nointerlineskip%
  \def\titleboxheight{\dimexpr\textheight - 4em\relax}%
  \vspace{2em}
  \begin{minipage}[c][\dimexpr .28\titleboxheight \relax][t]{\textwidth}\raggedright
...
\end{minipage}
\begin{minipage}[c][\dimexpr .24\titleboxheight \relax][b]{\textwidth}
