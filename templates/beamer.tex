...
\begin{frame}[fragile]{Frame title}
  Remember:
  \begin{itemize}
    \item Use the \texttt{fragile} option for minted environments.
    \item Use background templates and texpos as follows:
          \begin{minted}{latex}
\usebackgroundtemplate{\includegraphics{graphic.pdf}}
\begin{frame}
  % The textblock* environment does abolute positioning
  % First param is width of box, and second is coordinates
  % of left corner in ROUND brackets!
