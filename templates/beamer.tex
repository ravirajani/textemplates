...
{
  \vspace{2em}%
  \begin{minipage}[c][\dimexpr .33\paperheight - 2em\relax][t]{\textwidth}
  \usebeamercolor[fg]{title}
  \usebeamerfont{title}\inserttitle\par%
\end{minipage}
\begin{minipage}[c][.17\paperheight][t]{\textwidth}
  \usebeamercolor[fg]{title}
  \usebeamerfont{subtitle}\insertsubtitle\par%
\end{minipage}
\begin{minipage}[c][.25\paperheight][c]{\textwidth}
    \usebeamercolor[fg]{author}
  \usebeamerfont{author}\insertauthor\par%
  \usebeamerfont{institute}\insertinstitute\par%
  \usebeamerfont{date}\insertdate\par%
\end{minipage}
\begin{minipage}[c][\dimexpr .25\paperheight -2em \relax][b]{\textwidth}
  \usebeamercolor[fg]{titlegraphic}\inserttitlegraphic%
\end{minipage}
}

\defbeamertemplate*{frametitle}{OUFrameTitle}[1][left]
{
  \begin{minipage}[b][1.5cm][c]{\dimexpr \textwidth - 1.1cm \relax}
    \usebeamercolor{frametitle}
    \usebeamerfont{frametitle}\insertframetitle\par%
  \end{minipage}%
  \hfill
  \begin{minipage}[b][1.5cm][c]{1.1cm}
    \includegraphics[width=0.7cm,right]{OU_SHIELD_LOGO_BLUE_63mm.eps}%
\end{minipage}%
}
...
\setbeamerfont{title}{series=\bfseries,size=\fontsize{21pt}{24pt}}
\setbeamerfont{subtitle}{series=\mdseries,size=\fontsize{15pt}{18pt}}
...
\setbeamerfont{frametitle}{series=\bfseries,size=\fontsize{15pt}{17pt}}
...
\titlegraphic
{\includegraphics[height=0.9cm]{OU_Master_LOGO_WHITE_63mm.eps}}
