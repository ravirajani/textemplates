...
\begin{frame}{More Colours}
  \begin{minipage}{.5\textwidth}
    ...
    \end{exampleblock}
  \end{minipage}
  \begin{framedblock}[title=Framed Content]
    Some framed content.\strut
  \end{framedblock}
  \begin{alertblock}[title=Warning]
  \item Some warning.
  \item Other warning.
  \end{alertblock}
  \alertbox{Without title.}
  \infobox[Info]{Info body.}
\end{frame}
...
\setbeamercolor{background canvas}{bg=Core}
\setbeamertemplate{end page}[core][This line is optional]{Thank you}
\begin{frame}
